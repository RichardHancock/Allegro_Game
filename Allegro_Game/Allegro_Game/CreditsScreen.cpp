...
int CreditsScreen::run()
{
	...
	while(!exitScreen)
	{
		while(timer)
		{
			...
			textout_centre_ex(buffer, mainFont, "Ship - ", SCREEN_W / 2, 180,
				makecol(255,255,255),makecol(2,2,2));
			textout_centre_ex(buffer, mainFont, "Backgrounds - ", SCREEN_W / 2, 200,
				makecol(255,255,255),makecol(2,2,2));
			textout_centre_ex(buffer, mainFont, "SOUND:", SCREEN_W / 2, 240,
				makecol(255,255,255),makecol(2,2,2));
			textout_centre_ex(buffer, mainFont, "Laser - ", SCREEN_W / 2, 260,
				makecol(255,255,255),makecol(2,2,2));
